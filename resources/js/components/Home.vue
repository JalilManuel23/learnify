    ...
    <section id="planes">
      <div class="container">
        ...
        <h2 class="h1-responsive font-weight-bold text-center ">
          ...
          <!--Section description-->
          <p class="text-center w-responsive mx-auto mb-5">
            Eleva tu talento con el plan que mejor se amolde a tus necesidades.
          </p>
        <div class="row">
            <div class="col-md-12">
              <div class="row iq-star-inserted row-cols-1 row-cols-md-2 row-cols-lg-3 mb-5 text-center">
