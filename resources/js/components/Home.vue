      ...
      <div>
            ...
            <div class="card">
              ...
              <div class="card-body p-3">
                <div class="d-flex align-items-center">
                  <div>
                    <img src="../../img/desarrollo-ingenieria.png" class="img-fluid w-75 text-center">
                  </div>
                  <div class="ms-3">
                    <span class="h6 font-weight-bold mb-0">Desarrollo e Ingenería</span>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            ...
            <div class="card-body p-3">
              <div class="d-flex align-items-center">
                <div>
                  <img src="../../img/marketing.png" class="img-fluid w-75 text-center">
                </div>
                <div class="ms-3">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class="card">
            ...
            <div class="card-body p-3">
              <div class="d-flex align-items-center">
                <div>
                  <img src="../../img/english.png" class="img-fluid w-75 text-center">
                </div>
                <div class="ms-3">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class="card">
            ...
            <div class="card-body p-3">
              <div class="d-flex align-items-center">
                <div>
                  <img src="../../img/diseno-ux.png" class="img-fluid w-75 text-center">
                </div>
                <div class="ms-3">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class="card">
            ...
            <div class="card-body p-3">
              <div class="d-flex align-items-center">
                <div>
                  <img src="../../img/finanzas.png" class="img-fluid w-75 text-center">
                </div>
                <div class="ms-3">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class="card">
            ...
            <div class="card-body">
              <div class="d-flex align-items-center">
                <div>
                  <img src="../../img/videogame.png" class="img-fluid w-75 text-center">
                </div>
                <div class="ms-3">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class="card">
            ...
            <div class="card-body p-3">
              <div class="d-flex align-items-center">
                <div>
                  <img src="../../img/estilo-de-vida.png" class="img-fluid w-75 text-center">
                </div>
                <div class="ms-3">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class="card">
            ...
            <div class="card-body p-3">
              <div class="d-flex align-items-center">
                <div>
                  <img src="../../img/liderazgo.png" class="img-fluid w-75 text-center">
                </div>
                <div class="ms-3">
