<template>
    ...
    <section>
        <div class="container py-1 mt-5 mb-5" id="enlaces">
                ...
                <div class="row">
                    <div class="col-3">
                        <div id="list-example" class="list-group mt-5">
                            ...
                            <a class="list-group-item list-group-item-action list-group-item-light" href="#derechos-arco">Derechos ARCO</a>
                        </div>
                    </div>
                    <div class="col-9">
                        <div data-spy="scroll" data-target="#list-example" data-offset="0" class="scrollspy-example">
                            <div id="aviso-privacidad" class="py-5">
                                <h3 class=""><strong>Aviso de privacidad</strong></h3>
                                ...
                                <p class="py-5">
                                    ...
                                    Sit amet cursus sit amet dictum sit amet justo. Volutpat lacus laoreet non curabitur gravida arcu. Mi quis hendrerit dolor magna eget. Commodo ullamcorper a lacus vestibulum sed arcu non odio. Diam vulputate ut pharetra sit amet aliquam id diam maecenas. Feugiat scelerisque varius morbi enim nunc faucibus a. Habitant morbi tristique senectus et netus et malesuada. Placerat vestibulum lectus mauris ultrices. Sed viverra ipsum nunc aliquet bibendum. Tortor at risus viverra adipiscing. Nunc non blandit massa enim nec. Arcu felis bibendum ut tristique et. Suscipit adipiscing bibendum est ultricies integer quis auctor.

                                    Sed viverra tellus in hac. Iaculis at erat pellentesque adipiscing. Ullamcorper velit sed ullamcorper morbi tincidunt. Faucibus pulvinar elementum integer enim neque volutpat ac tincidunt. Turpis egestas maecenas pharetra convallis posuere morbi leo urna molestie. Fringilla phasellus faucibus scelerisque eleifend donec. At elementum eu facilisis sed odio morbi quis. Sit amet nisl purus in mollis nunc sed id. Orci porta non pulvinar neque. Nulla facilisi nullam vehicula ipsum a arcu cursus vitae. Et netus et malesuada fames ac turpis. Sit amet nulla facilisi morbi tempus iaculis. Purus in massa tempor nec feugiat nisl pretium fusce.

                                    Suscipit adipiscing bibendum est ultricies integer. Ultrices sagittis orci a scelerisque purus. Sed lectus vestibulum mattis ullamcorper velit sed ullamcorper morbi. Quam nulla porttitor massa id neque aliquam vestibulum morbi. Sed turpis tincidunt id aliquet risus feugiat in ante metus. Eu ultrices vitae auctor eu augue ut lectus arcu bibendum. Integer eget aliquet nibh praesent. Ut consequat semper viverra nam libero justo laoreet sit amet. Tincidunt dui ut ornare lectus sit amet est. Nibh mauris cursus mattis molestie a iaculis at erat pellentesque. Velit euismod in pellentesque massa. Dictumst quisque sagittis purus sit amet volutpat. Ultricies mi quis hendrerit dolor magna eget est lorem ipsum. Id cursus metus aliquam eleifend mi. Ut eu sem integer vitae justo eget magna fermentum. In eu mi bibendum neque egestas congue quisque egestas diam. Pulvinar sapien et ligula ullamcorper malesuada proin libero nunc. Vitae justo eget magna fermentum iaculis eu non diam phasellus. Arcu non sodales neque sodales. Ultrices in iaculis nunc sed augue lacus viverra.
                                </p>
                                <a class="ml-3 text-decoration-none" href="" download="">Descargar</a>
                            </div>
                            <div id="terminos-condiciones" class="py-5">
                                <h3 class=""><strong>Términos y condiciones</strong></h3>
                                <small class="text-muted">
                                    Fecha de última actualización :
                                </small>
                                <p class="py-5">
                            ...
                            <div id="politicas-calidad" class="py-5">
                                <h3 class=""><strong>Políticas de calidad</strong></h3>
                                <small class="text-muted">
                                    Fecha de última actualización :
                                </small>
                                <p class="py-5">
                            ...
                            <div id="derechos-arco" class="py-5">
                                <h3 class=""><strong>Derechos ARCO</strong></h3>
                                <small class="text-muted">
                                    Fecha de última actualización :
                                </small>
                                <p class="py-5">
