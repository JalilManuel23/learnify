<template>
  <div class="sidebar" v-bind:class="[(isOpen) ? 'open' : '']">
    ...
    <ul class="nav-list">
      ...
      <li>
        <router-link to="/crear-curso">
          <i class="fas fa-folder-plus" aria-hidden="true"></i>
          <span class="links_name">Crear curso</span>
        </router-link>
  ...
  <section class="home-section">
    ...
    <!-- Navbar -->
      <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 border-radius-xl" id="navbarBlur" navbar-scroll="true">
